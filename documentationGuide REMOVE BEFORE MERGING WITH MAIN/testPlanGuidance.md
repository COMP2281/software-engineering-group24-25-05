...
| **Coursework title**         | Test Plan                                 |
| **Coursework credits**       | 3 credits                                 |
| **% of module’s final mark** | 15%                                       |
| **Lecturer**                 | Nelly Bencomo                             |
| **Submission date\***        | Friday, February 7, 2025 14:00            |
| **Estimated hours of work**  | 6 hours                                   |
| **Submission method**        | Ultra                                     |

| **Additional coursework files**                            | _Please list all files provided for the coursework, e.g. datasets, template files_ |     |
| :--------------------------------------------------------- | :--------------------------------------------------------------------------------- | :-- |
| <p>**Required submission items**</p><p>**and formats**</p> | _Please list the files that should be submitted, including format_                 |     |
...
COMP2281: SOFTWARE ENGINEERING 2024/25

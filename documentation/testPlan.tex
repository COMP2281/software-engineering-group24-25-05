...
\begin{tabularx}{\linewidth}{|c|X|X|}
    ...
    \hline
    \textbf{utest\_5} & \textbf{Level Load + Transitions}: Test smooth transitions between levels and correct loading of level assets                          & Level data persists, and transitions occur without graphics or gameplay glitches                                                                   \\
    \hline
...
\begin{center}
    \begin{tabularx}{\linewidth}{|>{\raggedright\arraybackslash}m{4cm}|X|}
        ...
        \textbf{Performance}
        \begin{itemize}
            \item Game runs at an acceptable frame rate ($60 \geq$), with minimal changes in frame rate when performing actions.

...
\begin{tabularx}{\linewidth}{|>{\raggedright\arraybackslash}m{4cm}|X|}
    ...
    \hline
    \textbf{Description of test} & Test the interaction between the game character and an NPC, including the dialogue system, sneaking mechanism, and NPCs' reaction to the player. Making it fit the game's story and integrates smoothly into IBM Skills Build-related content. \\
    \hline
    \textbf{Related requirement document details} & \makecell[l]{
...
\begin{tabularx}{\linewidth}{|>{\raggedright\arraybackslash}m{4cm}|X|}
    ...
    \textbf{Result} &
     \begin{itemize}
        \item The game is smooth and can run normally.
        \item Players are able to sneak and fight without any problems, and the learning content does not spoil the game experience.
        \item The AI is not able to adjust difficulty of the game.
        \item Quiz sections are not triggered while the player is in combat.
    \end{itemize}
    \\
    \hline
    \textbf{Pass/Fail} & Partial Pass \\
    \hline
    \textbf{Severity (If Fail)} & Moderate: Gameplay is impacted and may seem unfair and or inconsistent. \\
    \hline
    \textbf{Comments} & None \\
    \hline
\end{tabularx}

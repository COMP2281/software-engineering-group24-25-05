...
\begin{tabularx}{\linewidth}{|c|X|X|>{\raggedright\arraybackslash}m{2cm}|}
    ...
    \hline
    \textbf{stest\_3} & Gameplay Flow: Test the game mechanics, including mission progression, level transitions, and story continuity & Gameplay progresses smoothly without logic errors or broken sequences & Functional \& Non-Functional \\
    \hline

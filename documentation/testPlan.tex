...
\begin{center}
    \begin{tabularx}{\linewidth}{|>{\raggedright\arraybackslash}m{4cm}|X|}
        ...
        \hline
        \textbf{Description of test}                  & Test the interaction between the game character and an NPC, including the dialog system, sneaking mechanism, and NPCs' reaction to the player. Making it fit the game's story and integrates smoothly into IBM Skills Build-related content. \\
        \hline
        \textbf{Related requirement document details} & \makecell[l]{

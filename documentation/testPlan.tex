...
\begin{tabularx}{\linewidth}{|>{\raggedright\arraybackslash}m{4cm}|X|}
    ...
    \hline
    \textbf{Description of test} & The application successfully pulls the correct questions and answers from the question bank. \\
    \hline
    \textbf{Related requirement document details} & Educations Engagement (2.2.2) \\
    \hline
    \textbf{Prerequisites for test} & The game is installed and functional, and the question bank is populated with course-specific questions and answers. \\
    \hline
    \textbf{Test procedure} &
    \begin{itemize}
        \item Launch the game.
        \item Select a course.
        \item Verify that the application retrieves questions from the selected course.
        \item Cross-check the correctness of the answers with the question bank.
    \end{itemize}
    \\
    \hline
    \textbf{Expected result} &
    \begin{itemize}
        \item The questions displayed are relevant to the selected course.
        \item Each question is associated with four answers.
        \item Only one of the answers is marked as correct and matches the data in the question bank.
    \end{itemize}
    \\
    \hline
    \textbf{Comments} & Each question must have at least one correct answer. \\
    \hline
    \textbf{Created by} & BM \\
    \hline
    \textbf{Test environment(s)} & Windows 11, Mac OS 15.3, Unity 2022.3.50f1 \\

...
\begin{tabularx}{\linewidth}{|>{\raggedright\arraybackslash}m{4cm}|X|}
    ...
    \\
    \hline
    \textbf{Comments} & The order in which levels are completed is given by the story. \\
    \hline
    \textbf{Created by} & VE \\
    \hline
    \textbf{Test environment(s)} & Windows 11, Mac OS 15.3, Unity 2022.3.50f1 \\
...
\begin{tabularx}{\linewidth}{|>{\raggedright\arraybackslash}m{4cm}|X|}
    ...
    \textbf{Pass/Fail} & Partial Pass \\
    \hline
    \textbf{Severity (If Fail)} & Critical: Game progression is impeded. \\
    \hline
    \textbf{Comments} & None \\
    \hline
\end{tabularx}
...
\begin{tabularx}{\linewidth}{|>{\raggedright\arraybackslash}m{4cm}|X|}
    ...
    \hline
    \textbf{Expected result (test oracle)} &
    \textbf{Display}
    \begin{itemize}
...
\begin{tabularx}{\linewidth}{|>{\raggedright\arraybackslash}m{4cm}|X|}
    ...
    \textbf{Pass/Fail} & Pass \\
    \hline
    \textbf{Severity (If Fail)} & Critical: If for some reason a question has no correct answers the player cannot progress thus game progression is impeded. \\
    \hline
    \textbf{Comments} & None \\
    \hline
\end{tabularx}
...
\begin{tabularx}{\linewidth}{|>{\raggedright\arraybackslash}m{4cm}|X|}
    ...
    \textbf{Pass/Fail} & Pass \\
    \hline
    \textbf{Severity (If Fail)} & Critical: If the main mission is not set as completed even though the player has finished it game progression is impeded. \\
    \hline
    \textbf{Comments} & None \\
    \hline
\end{tabularx}
...
\begin{tabularx}{\linewidth}{|>{\raggedright\arraybackslash}m{4cm}|X|}
    ...
    \begin{itemize}
        ...
        \item Test the smoothness of the game operation to ensure that there is no delay or abnormality in switching between sneaking, fighting and answering questions.
